...
SECRET_KEY = os.environ.get('SECRET_KEY','8x6jpnhq*44@8y(i=@l_*6m2@d0c4+57dbr0d84l4qvk@2o2z%')
...
STATIC_ROOT = 'staticfiles'  # Répertoire de collecte des fichiers statiques pour la production
STATIC_URL = 'static/' \
