...
# SECURITY
SECRET_KEY = os.environ.get('SECRET_KEY', 'x*los%fab=mm4h1d@4tq9*r$p&$1w6%0k8hi+j^92smt))x+)*')
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'bibliotheque.onrender.com',  # ← Remplacez par le nom exact de votre service Render
]

CSRF_TRUSTED_ORIGINS = [
    'https://bibliotheque.onrender.com',  # ← Remplacez par le nom exact de votre service Render
]
